...
def features(lfm, ab_high, ab_low):
    ...
    rv = {
        ...
        # "Duration": ab_high['metadata']['audio_properties']['length'],
        ...
        "ABL - Beats Count": ab_low['rhythm']['beats_count'],
        "ABL - Tempo (BPM)": ab_low['rhythm']['bpm'],
    }
